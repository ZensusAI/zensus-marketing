...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Zensus · Cash flow forecasting for startups with variable revenue</title>
        ...
        <meta property="og:title" content="Zensus · Cash flow forecasting for startups" />
        ...
        <meta name="twitter:title" content="Zensus · Cash flow forecasting for startups" />
