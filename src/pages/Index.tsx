...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Zensus · Cash flow forecasting for businesses of any size</title>
        ...
        <meta property="og:title" content="Zensus · Cash flow forecasting for businesses" />
        <meta property="og:description" content="A cash flow forecast that knows your annual contract hits March 14, not 'sometime in Q1.' Built for businesses of any size." />
        ...
        <meta name="twitter:title" content="Zensus · Cash flow forecasting for businesses" />
        <meta name="twitter:description" content="A cash flow forecast that knows your annual contract hits March 14, not 'sometime in Q1.' Built for businesses of any size." />
