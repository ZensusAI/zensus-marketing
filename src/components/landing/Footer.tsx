...
/** Google Maps embeds: city-level only (no street addresses), one per office. */
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-10">
          <div className="flex flex-col gap-8 lg:col-span-4">
            ...
            <div className="w-full max-w-md">
              <p className="text-left text-xs font-medium uppercase tracking-wide text-[hsl(var(--forest-muted))]">Our offices</p>
              <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <p className="text-left text-base font-semibold text-[hsl(var(--forest-foreground))]">Austin, TX</p>
                  <div className="relative mt-2 aspect-[5/2] w-full overflow-hidden rounded-xl border border-white/10 bg-black/20 shadow-inner">
                    <iframe
